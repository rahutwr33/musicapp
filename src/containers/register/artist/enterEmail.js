...
import {ARTIST_PASSWORD_SCREEN} from '../../../navigation/screen';
    ...
    if (email) {
      if (Validator.isEmail(email)) {
        ...
        if (verify && verify.success) {
          await props.setArtistValue({email: email});
          setMessage('');
          setStatus(true);
          PushScreen(ARTIST_PASSWORD_SCREEN, props);
        } else {
...
export default connect(mapStateToProps, mapDispatchToProps)(ArtistEmailScreen);
