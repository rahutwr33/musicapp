...
const HeavyRotation = (props) => {
  ...
  return (
    <View>
      {props.heavyrotation && props.heavyrotation.length > 0 ? (
        <View style={styles.liststyle}>
          <View style={styles.spacingtop}>
            <Text style={styles.fontstyle}>{t('Your_heavy_rotation')}</Text>
          </View>
          <FlatList
...
export default connect(mapStateToProps, mapDispatchToProps)(HeavyRotation);
